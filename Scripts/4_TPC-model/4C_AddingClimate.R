...
###################################################################################################
#######################################Adding climate to mean_df_subset################################################################################################################################

#The purpose of this script is to add my climate variables to the mean_df_subset file (mean estimates for all population-level parameters) for ease of graphing clines later on
...
write.csv(mean_df_subset, "Processed-data/mean_df_subsetwithclim.csv", row.names = FALSE)
